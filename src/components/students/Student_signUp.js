...
import StudentNavbarSignup from "./studentnavsignup";
const StudentSignUp = () => {
    ...
    //     navigate('/studentlogin')};
        ...
        const response = await fetch("http://localhost:8080/student_signup", {
          method: "POST",
          headers: {
    ...
    return (
        <div>
            <StudentNavbarSignup/>
        <section class="h-100 h-101" style={{backgroundColor:"#DDC577"}}>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-xl-6">
                                    <div class="card-body p-md-5 text-black">
                                        ...
                                        <div class="d-flex justify-content-end pt-3">
                                            <button type="button" class="btn btn-warning btn-lg ms-4" onClick={()=>{navigate('/studentlogin')}} >Click for Log in</button>
                                        </div>
